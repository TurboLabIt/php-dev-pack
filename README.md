...
````bash
symfony composer config repositories.turbolabit/php-dev-pack git https://github.com/TurboLabIt/php-dev-pack.git
symfony composer require turbolabit/php-dev-pack:dev-master
